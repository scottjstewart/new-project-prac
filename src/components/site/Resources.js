  ...
  return (
    <div className="main">
      <div className="mainDiv">
        ...
        <p>
          {" "}
          Below are some listed resources used through the creation of this
        ...
        <ul>
          ...
          <li>
            http://neptunian.github.io/react-photo-gallery/examples/basic.html
          </li>
          <li>https://github.com/ngokevin/aframe-react-boilerplate</li>
        </ul>
        <h1>More Reading</h1>
        <p>Here are some extra resources that may help!</p>
        <ul>
          <li>Extra</li>
          <li>Movie App</li>
        </ul>
